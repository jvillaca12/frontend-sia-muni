...
import EmpleadoHistorialTable from './EmpleadoHistorialTable';

const ViewTableHistorialEmpleado = (): ReactElement => {
...
export default ViewTableHistorialEmpleado;
