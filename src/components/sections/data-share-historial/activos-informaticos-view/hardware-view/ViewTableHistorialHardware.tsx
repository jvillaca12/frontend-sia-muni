...
import HardwareHistorialTable from './HardwareHistorialTable';

const ViewTableHistorialHardware = (): ReactElement => {
    ...
    <Box>
      ...
      >
        <Typography variant="h4" color="common.white" fontWeight={'Bold'}>
          Lista de los Activos Informáticos que son Hardware
        </Typography>
        <TextField
          variant="filled"
          placeholder="Buscar..."
...
export default ViewTableHistorialHardware;
