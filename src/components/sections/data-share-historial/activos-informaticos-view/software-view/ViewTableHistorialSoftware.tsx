...
import SoftwareHistorialTable from './SoftwareHistorialTable';

const ViewTableHistorialSoftware = (): ReactElement => {
    ...
    <Box>
      ...
      >
        <Typography variant="h4" color="common.white" fontWeight={'Bold'}>
          Lista de los Activos Informáticos que son Software
        </Typography>
        <TextField
          variant="filled"
          placeholder="Buscar..."
...
export default ViewTableHistorialSoftware;
