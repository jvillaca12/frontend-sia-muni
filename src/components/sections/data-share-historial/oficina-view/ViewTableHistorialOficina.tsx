...
import OficinaHistorialTable from './OficinaHistorialTable';

const ViewTableHistorialOficina = (): ReactElement => {
...
export default ViewTableHistorialOficina;