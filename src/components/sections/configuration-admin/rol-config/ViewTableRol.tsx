...
import FormRegistroRol from './FormRegistrarRol';

const ViewTableRol = (): ReactElement => {
  ...
  return (
    <Box>
      ...
      <Modal open={isModalOpen} onClose={handleCloseModal}>
        <FormRegistroRol onClose={handleCloseModal} onSuccessRegistro={handleRefreshTable} />
      </Modal>
      <ReusableModal
