...
import RedHistorialTable from './RedHistorialTable';

const ViewTableHistorialRed = (): ReactElement => {
    ...
    <Box>
      ...
      >
        <Typography variant="h4" color="common.white" fontWeight={'Bold'}>
          Lista de los Activos Informáticos que son de Infraestructura de Red
        </Typography>
        <TextField
          variant="filled"
          placeholder="Buscar..."
...
export default ViewTableHistorialRed;
