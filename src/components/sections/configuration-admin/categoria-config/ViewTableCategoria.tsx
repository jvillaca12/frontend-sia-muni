...
import FormRegistroCategoria from './FormRegistroCategoria';
import ReusableModal from 'components/common/ResuableDialog';

const ViewCategoriaData = (): ReactElement => {
  ...
  // Funcion para abrir el menu de registro de categoria
  ...
  return (
    <Box>
      ...
      <Modal open={isModalOpen} onClose={handleCloseModal}>
        <FormRegistroCategoria onClose={handleCloseModal} onSuccessRegistro={handleRefreshTable} />
      </Modal>
      <ReusableModal
...
export default ViewCategoriaData;
