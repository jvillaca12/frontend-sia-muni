...
import FormRegistrarTP from './FormRegistrarTP';
import ReusableModal from 'components/common/ResuableDialog';

const ViewTipoManData = (): ReactElement => {
  ...
  return (
    <Box>
      ...
      <Modal open={isModalOpen} onClose={handleCloseModal}>
        <FormRegistrarTP onClose={handleCloseModal} onSuccessRegistro={handleRefreshTable} />
      </Modal>
      <ReusableModal
...
export default ViewTipoManData;
