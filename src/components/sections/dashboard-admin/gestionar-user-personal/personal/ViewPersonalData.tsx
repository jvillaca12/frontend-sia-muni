...
import PersonalTable from './PersonalDataTable';
import FormRegistroPersonal from './FormRegistroPersonal';
import ReusableModal from 'components/common/ResuableDialog';

const ViewPersonalData = (): ReactElement => {
  ...
  // estado para buscar en la tabla del personal
  ...
  return (
    <Box>
      ...
      <Modal open={isModalOpen} onClose={handleCloseModal}>
        <FormRegistroPersonal onClose={handleCloseModal} onSuccessRegistro={handleRefreshTable} />
      </Modal>
      <ReusableModal
...
export default React.memo(ViewPersonalData);
