...
import { rows } from './historial-hardware';
...
// props de la tabla de HardwareHistorialTable
const HardwareHistorialTable = ({
  searchText,
  onExportPDF,
  onExportExcel,
  onFilteredRowCountChange,
}: {
  // pasando las props de la tabla de HardwareHistorialTable
  searchText: string;
  onExportPDF: (func: () => void) => void;
  onExportExcel: (func: () => void) => void;
  onFilteredRowCountChange: (count: number) => void;
}): ReactElement => {
  // estado de la tabla de HardwareHistorialTable
  ...
  // columnas de la tabla de HardwareHistorialTable
    ...
    (type: 'current' | 'filtered' | 'all') => {
      ...
      if (exportType === 'PDF') {
        exportToPDF(
          ...
          'hardware-reporte',
          type,
          'Reporte de los de los activos informáticos con relación a Hardware de la MPP',
          user,
          'Reporte de toda la información de los activos informáticos con relación a Hardware, de acuerdo al registro en tiempo real del sistema',
        );
      } else {
...
export default HardwareHistorialTable;
