...
import IncidenciaFalloTable from './IncidenciaFalloTable';

const ViewTableHistorial = (): ReactElement => {
    ...
    <Box>
      ...
      >
        <Typography variant="h4" color="common.white">
          Historial de registro de los detalles problemas
        </Typography>
        <TextField
          variant="filled"
          placeholder="Buscar..."
...
export default ViewTableHistorial;
