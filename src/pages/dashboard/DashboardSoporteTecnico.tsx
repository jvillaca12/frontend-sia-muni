...
import IncidenciasItemsSoporte from 'components/sections/dashboard-soporte/detalle-problema/IncidenciasItemSoporte';

const DashboardSoporteTecnico = (): ReactElement => {
  return (
    <>
      <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gap={3.5}>
        <Box gridColumn={{ xs: 'span 12', '2xl': 'span 8' }} order={{ xs: 0 }}>
          <IncidenciasItemsSoporte />
        </Box>
...
export default DashboardSoporteTecnico;
